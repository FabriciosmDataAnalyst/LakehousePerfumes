...
export default tseslint.config(
  // Global ignores
  {
    ignores: [
      ...
      'client/dist/**',
      '**.databricks/**',
      // Auto-generated by AppKit typegen (shared/appkit-types/analytics.d.ts,
      // metric-views.ts, serving.d.ts). "DO NOT EDIT" — regenerating typegen
      // always re-emits unused marker imports, so linting them only produces
      // noise.
      'shared/appkit-types/**',
    ],
  },
